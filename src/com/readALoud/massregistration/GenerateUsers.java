...
public class GenerateUsers {
	...
	public User createUser() {
		...
		int P = ran.nextInt(password.length);

		String email = names[F]+names[L]+ ".@email.com";
		Date date = getRandomDOB();
		User u = new User(names[F],names[L], email, password[P], date);
	...
	public Reader createReader() {
		...
		String email = names[F]+names[L]+ ".@email.com";
		Date date = getRandomDOB();
		Reader u = new Reader(names[F],names[L], email, password[P], date);
	...
	public Author createAuthor() {
		...
		String email = names[F]+names[L]+ ".@email.com";
		Date date = getRandomDOB();
		Author u = new Author(names[F],names[L], email, password[P], date);
	...
	private static final String[] password = { "password", "root", "pass" };
